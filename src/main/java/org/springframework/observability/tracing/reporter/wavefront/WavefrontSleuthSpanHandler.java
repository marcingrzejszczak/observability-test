 ...
 * @since 3.1.0
 */
public class WavefrontSleuthSpanHandler implements Runnable, Closeable {
	 ...
	 */
	public WavefrontSleuthSpanHandler(int maxQueueSize, WavefrontSender wavefrontSender, MeterRegistry meterRegistry,
